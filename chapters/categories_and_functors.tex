...
One reason why the objects $\ob(\C)$ of a category is not generally a set, is that sets require the axiom of regularity, 
...
\begin{itemize}
    \item $\ob(\mathcal{G}) := \{\epsilon\}$ contains a single element,
