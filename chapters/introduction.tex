...
And a clustering algorithm will be a map assigning to a finite metric space either a \emph{partition} or a \emph{dendrogram} of the underlying set.
...
\begin{subfigure}[t]{0.45\textwidth}
    ...
    \end{tikzpicture}
    \caption{A dendrogram of five points.}
\end{subfigure}
\end{figure}
