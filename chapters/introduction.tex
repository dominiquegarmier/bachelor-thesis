...
We think of a clustering algorithm as mapping a finite metric space to either a \emph{partition} or a \emph{dendogram} of the underlying set.
...
\begin{subfigure}[t]{0.45\textwidth}
    ...
    \end{tikzpicture}
    \caption{A dendogram of five points.}
\end{subfigure}
\end{figure}

A dendogram is a (rooted) tree where the leaves are the data points. Dendograms are strictly more general than partitions, as at every \emph{scale} a dendogram describes a partition of the data points.
