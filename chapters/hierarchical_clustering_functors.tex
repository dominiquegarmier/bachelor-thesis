...
We will talk about a crucial link between certain hierarchical clustering functors and regular classical clustering functors. With this, we can then tackle the modified \textsc{Kleinberg} conditions \cite[Sec.~7.3.1]{Carlsson2010} and show that they give uniqueness.
...
\todo[might want to elaborate on the last two sentences]
