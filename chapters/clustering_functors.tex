...
\begin{itemize}
    ...
    \item A single equivalence class $X_\alpha \in P$ will be called a \emph{block} or \emph{part} of $P$ \todo[i dont ever use this notation].
\end{itemize}
\end{definition}
...
\begin{definition}{Dendogram \cite[Definition~2.2]{Carlsson2010}}{dendogram}
...
This will be familiar to anyone who has seen \emph{persistent homology} where such properties are referred to as \emph{persistence} \cite[Chapter~3]{Carlsson2014}. 
...
\begin{definition}{\cite[Definition~3.2]{Carlsson2010}}{output_classical_clustering_functors}
...
\begin{definition}{\cite[Definition~3.3]{Carlsson2010}}{output_hierarchical_clustering_functors}
...
For a hierarchical clustering functor $\Cf$ we will use the simplified notation:
$$
\Cf(X,d;r) := (X,\theta_X(r)).
$$
Moreover, for any $r \in \R_{\geq0}$ a hierarchical clustering functor $\Cf$ induces a classical clustering functor $\Cf(\ \cdot \ ;r)$.
