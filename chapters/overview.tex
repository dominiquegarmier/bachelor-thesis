...
\begin{enumerate}
    ...
    \item No matter what the firendship groups are, the guests could arrange themselfs appropriately such that our algorithm can detect them (\ie, guests in the same group move close together).
