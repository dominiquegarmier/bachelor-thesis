...
\begin{tikzpicture}
    ...
    \draw[dashed, color=myred] (-1.9, 2.4) -- (2.2, -2); % diff = (4.3, -4.4)
    \draw[->, color=myred, >=stealth] (-1.47, 1.96) -- (-1.47 + 0.215, 1.96 + 0.22);
    \draw[->, color=myred, >=stealth] (1.77, -1.56) -- (1.77 + 0.215, -1.56 + 0.22);
\end{tikzpicture}
