...
\begin{subfigure}[t]{0.45\textwidth}
    ...
    \begin{tikzpicture}[sloped]
        ...
        \draw[<->, dashed, color=mypurple, >=stealth] (a) -- (b) node[midway, above] {\tiny{$d(a,b) = 1$}};

        \draw[<->, dashed, color=mypurple, >=stealth] (b) -- (c) node[midway, above] {\tiny{$d(b,c) = 2$}};
        \draw[<->, dashed, color=mypurple, >=stealth] (a) -- (c) node[midway, below] {\tiny{$d(a,c) = 2$}};

        \draw[<->, dashed, color=mypurple, >=stealth] (c) -- (e) node[midway, above] {\tiny{$d(c,e) = 3$}};
        \draw[<->, dashed, color=mypurple, >=stealth] (c) -- (d) node[midway, below] {\tiny{$d(c,c) = 3$}};

        \draw[<->, dashed, color=mypurple, >=stealth] (e) -- (d) node[midway, above] {\tiny{$d(d,e) = 1$}};
    \end{tikzpicture}
