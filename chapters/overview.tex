...
Let us now consider a clustering algorithm that will produce a dendrogram as an ouput. We will achieve this by consecutively merging clusters based on some distance criterion \cite[Sec.~4.2.2]{Everitt2011}.
