...
In the simplest case this ``grouping'' is \emph{partition} of the original datapoints, this is also called \emph{classical clustering} (see Figure \ref{fig:dc_partition}). Alternatively we could assing a so-called \emph{dendrogram}
