{};
    \node[circle,fill=black,inner sep=1pt, color=myblue] at (-1.8902258184052567,0.7894776893682616) {};
    \node[circle,fill=black,inner sep=1pt, color=myblue] at (-0.6273208428361784,-1.8371947162534354) {};
    \node[circle,fill=black,inner sep=1pt, color=myblue] at (-0.9885817783568538,-1.7147623663359197) {};
    \node[circle,fill=black,inner sep=1pt, color=myblue] at (-0.9386023582122706,-1.7236389913807584) {};
    \node[circle,fill=black,inner sep=1pt, color=myblue] at (-1.3401106297221774,1.5451099391524472) {};
    \node[circle,fill=black,inner sep=1pt, color=myblue] at (-1.7696595846944951,-0.835412527730738) {};
    \node[circle,fill=black,inner sep=1pt, color=myblue] at (-1.94149620924287,0.7884962462992549) {};
    \node[circle,fill=black,inner sep=1pt, color=myblue] at (-1.1613066182943586,-1.6658708071329087) {};
    \node[circle,fill=black,inner sep=1pt, color=myblue] at (-1.9737616591333986,0.42415122258148036) {};
    \node[circle,fill=black,inner sep=1pt, color=myblue] at (-1.0910291132157077,-1.6346094222929535) {};
    \node[circle,fill=black,inner sep=1pt, color=myblue] at (-1.420125841706075,1.5367643867093461) {};
    \node[circle,fill=black,inner sep=1pt, color=myblue] at (0.8773373323041873,-1.83463023722728) {};
    \node[circle,fill=black,inner sep=1pt, color=myblue] at (1.0295543643648137,-1.6695857338970421) {};
    \node[circle,fill=black,inner sep=1pt, color=myblue] at (-1.9628887251833387,0.3917097103265355) {};
    \node[circle,fill=black,inner sep=1pt, color=myblue] at (-1.6082435557290202,-1.2449832245663626) {};
    \node[circle,fill=black,inner sep=1pt, color=myblue] at (-0.1367588700508612,-2.0242149878928153) {};


    \draw[circle, dashed](0,0) circle (1);
    \draw[circle, dashed](0,0) circle (2);

    \draw[dashed, color=myred] (-1.9, 2.4) -- (2.2, -2); % diff = (4.1, -4.4)
    \draw[->, color=myred, >=stealth] (-1.9 + 0.41, 2.4 - 0.44) -- (-1.9 + 0.41 + 0.205, 2.4 - 0.44 + 0.22);
    \draw[->, color=myred, >=stealth] (2.2 - 0.41, -2 + 0.44) -- (2.2 - 0.41 + 0.205, -2 + 0.44 + 0.22);
\end{tikzpicture}
\caption{Points generated by adding noise to two circles. $k$-means ($k = 2$) splits along the black line \todo[color the points].}
\end{figure*}

In this case the $k$-means algorithm ($k = 2$) will fail to split the two circles as the clusters will always be convex and therefore split the data along a line.
...
A dendogram is in this context a (rooted) binary tree where the leaves are the data points. We will later define a more general notion of a dendogram in section \ref{section__partitions}.
...
\begin{subfigure}[t]{0.45\textwidth}
    ...
    \begin{tikzpicture}[sloped]
        \node[circle,fill=black,inner sep=1pt, label={below:\small$a$}] (a) at (0, 0) {};
        \node[circle,fill=black,inner sep=1pt, label={\small$b$}] (b) at (0, 1.5) {};
        \node[circle,fill=black,inner sep=1pt, label={\small$c$}] (c) at (2.25, 0.75) {};
        \node[circle,fill=black,inner sep=1pt, label={below:\small$d$}] (d) at (6, 0) {};
        \node[circle,fill=black,inner sep=1pt, label={\small$e$}] (e) at (6, 1.5) {};

        \draw[<->, dashed, color=myblue, >=stealth] (a) -- (b) node[midway, above] {\tiny{$d(a,b) = 1$}};

        \draw[<->, dashed, color=myblue, >=stealth] (b) -- (c) node[midway, above] {\tiny{$d(b,c) = 2$}};
        \draw[<->, dashed, color=myblue, >=stealth] (a) -- (c) node[midway, below] {\tiny{$d(a,c) = 2$}};

        \draw[<->, dashed, color=myblue, >=stealth] (c) -- (e) node[midway, above] {\tiny{$d(c,e) = 3$}};
        \draw[<->, dashed, color=myblue, >=stealth] (c) -- (d) node[midway, below] {\tiny{$d(c,c) = 3$}};

        \draw[<->, dashed, color=myblue, >=stealth] (e) -- (d) node[midway, above] {\tiny{$d(d,e) = 1$}};
    \end{tikzpicture}
