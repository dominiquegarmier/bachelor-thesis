...
\end{tikzpicture}
\caption{Points generated by adding noise to two circles. $k$-means ($k = 2$) splits along the black line.}
\end{figure*}
...
\begin{subfigure}[t]{0.45\textwidth}
    ...
    \begin{tikzpicture}[sloped]
        \node[circle,fill=black,inner sep=1pt, label={\small$a$}] at (0, 0) {};
        \node[circle,fill=black,inner sep=1pt, label={\small$b$}] at (0, 1) {};
        \node[circle,fill=black,inner sep=1pt, label={\small$c$}] at (1.5, 0.5) {};
        \node[circle,fill=black,inner sep=1pt, label={\small$d$}] at (4, 0) {};
        \node[circle,fill=black,inner sep=1pt, label={\small$e$}] at (4, 1) {};
    \end{tikzpicture}
